...
- (void)initMainMenu
{
    ...
    self.addSection(ZZFDMainSectionTypeHeaderSpace).sectionInsets(UIEdgeInsetsMake(10, 0, 0, 0));
    ...
    // ZZFlexibleLayoutViewController
    {
        ...
        self.addCell(ClassMenuCell).withDataModel(@"新版微信“设置” (XIB)").toSection(sectionTag).selectedAction(^(id model){
            @strongify(self);
