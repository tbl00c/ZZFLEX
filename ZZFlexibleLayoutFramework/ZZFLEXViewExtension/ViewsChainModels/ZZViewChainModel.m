...
{
    return ^__kindof ZZViewChainModel *(CGFloat cornerRadius) {
...
{
    return ^__kindof ZZViewChainModel *(CGFloat borderWidth, UIColor *borderColor) {
...
{
    return ^__kindof ZZViewChainModel *(CGSize shadowOffset, CGFloat shadowRadius, UIColor *shadowColor, CGFloat shadowOpacity) {
